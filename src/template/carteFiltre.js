    ...
    creationCarte() {
        ...
        const contactCard = `
            <div class="container-menu" role="select menu" >
                <button class='btn-filter' role=”button” aria-expanded="false" aria-haspopup=”listbox” aria-controls="widget1">Popularité <i class="fa-sharp fa-solid fa-chevron-up" style="color: #ffffff;"></i></button>
                <div class="menu">
