    ...
    creationCarte() {
        ...
        setTimeout(()=>{
                document.querySelector(".btn-filter").addEventListener("click",(e)=>{ // open/close menu
                    ...
                    let open = e.target.getAttribute("aria-expanded");
                ...
                document.querySelectorAll(".sousMenu").forEach(item=>item.addEventListener("click",async(e)=>{ // update btn affichage
                    ...
                    if(btn.innerText == "Popularité")
                    {
                        ...
                        let mediaFiltre = await this.mediaApi.filtrerParPopularite(this.photographe.id);
                    ...
                    else if (btn.innerText == "Date")
                    {
                        ...
                        let mediaFiltre = await this.mediaApi.filtrerParDate(this.photographe.id);
                        console.log(mediaFiltre);
                    ...
                    else if (btn.innerText == "Titre")
                    {
                        ...
                        let mediaFiltre = await this.mediaApi.filtrerParTitre(this.photographe.id);
                        console.log(mediaFiltre);
